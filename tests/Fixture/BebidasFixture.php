 ...
 *
 */
class BebidasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'disponivel' => ['type' => 'string', 'length' => 45, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'categorias_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_bebidas_categorias1_idx' => ['type' => 'index', 'columns' => ['categorias_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_bebidas_categorias1' => ['type' => 'foreign', 'columns' => ['categorias_id'], 'references' => ['categorias', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'disponivel' => 'Lorem ipsum dolor sit amet',
            'categorias_id' => 1
        ],
    ];
}
