 ...
 *
 */
class FilaentregasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_filaentregas_pedidos1_idx' => ['type' => 'index', 'columns' => ['pedidos_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_filaentregas_pedidos1' => ['type' => 'foreign', 'columns' => ['pedidos_id'], 'references' => ['pedidos', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            'id' => 1,
            'chegada' => '2016-11-01 12:53:04',
            'status' => 'Lorem ipsum dolor sit amet',
            'observacoes' => 'Lorem ipsum dolor sit amet',
            'posicao' => 1,
            'saida' => '2016-11-01 12:53:04',
            'pedidos_id' => 1
        ],
    ];
}
