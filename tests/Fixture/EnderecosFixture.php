...
class EnderecosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'numero' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_enderecos_consumidores_idx' => ['type' => 'index', 'columns' => ['consumidores_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_enderecos_consumidores' => ['type' => 'foreign', 'columns' => ['consumidores_id'], 'references' => ['consumidores', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
